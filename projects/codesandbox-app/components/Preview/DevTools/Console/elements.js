...
export const Container = styled.div `
  background-color: ${props => props.theme['panel.background'] || props.theme.background};
...
export const FilterInput = styled.input `
  ...
  background-color: ${props => props.theme['input.background'] || 'rgba(255, 255, 255, 0.1)'};
...
export const inspectorTheme = theme => ({
    ...
    LOG_COLOR: theme['terminal.foreground'] ||
