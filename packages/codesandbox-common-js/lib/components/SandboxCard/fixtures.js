...
export const popularSandbox = (config = {}) => sandbox({
    view_count: 999999999,
    fork_count: 999999999,
    like_count: 999999999,
    ...config,
});
export const sandboxWithManyTags = (config = {}) => sandbox({
    tags: [
        'tag1',
        'tag2',
        'tag3',
...
export const sandboxWithLongTitle = (config = {}) => sandbox({
...
export const sandboxWithLongDescription = (config = {}) => sandbox({
...
export const sandboxWithNullAuthor = (config = {}) => sandbox({
    author: null,
});
export const sandboxWithUndefinedAuthor = (config = {}) => sandbox({
    author: undefined,
});
export const sandboxWithNullScreenshotUrl = (config = {}) => sandbox({
    screenshot_url: null,
});
export const sandboxWithUndefinedScreenshotUrl = (config = {}) => sandbox({
...
export const templateOptions = templates.reduce((acc, key) => ({
    ...acc,
    [key]: key,
}), {});
