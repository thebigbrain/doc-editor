      ...
      <Tooltip style={{display: 'flex'}} content="Open Source Contributor to CodeSandbox">
        <IconBase style={style} width="1em" height="0.67em" viewBox="0 0 284 192" fill="none">
          <path
            ...
            transform="translate(0 112.408)" fill="#C5A56B"/>
          <path
            ...
            transform="translate(0 99.9999)" fill="#EAC17A"/>
          <path
            ...
            transform="translate(26.3443 2.85638)" fill="#E1BD7B"/>
          <path
            ...
            transform="translate(78.6721 32.7479)" fill="#CFAE72"/>
          <path
            ...
            transform="translate(9 2.43616)" fill="#AD915F"/>
          <path
            ...
            transform="translate(29.5 0.21521)" fill="#CFAE72"/>
          <path
            ...
            transform="translate(9.00001 144.841)" fill="#E1BD7B"/>
          <path
          ...
          <path
            ...
            transform="translate(245 117.4)" fill="#AD915F"/>
          <path
            ...
            transform="translate(247.492 118.148)" fill="#C5A56B"/>
          <path
            ...
            transform="translate(128.293)" fill="#E1BD7B"/>
          <path
            ...
            transform="translate(48 161.596)" fill="#FCF7DE"/>
          <path
          ...
          <path
            ...
            transform="translate(30.2886 155.69)" fill="#FCF7DE"/>
        </IconBase>
      </Tooltip>
    </a>)
  }
