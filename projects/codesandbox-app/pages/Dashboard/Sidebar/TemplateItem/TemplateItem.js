...
import TemplateIcon from '@csb/common/lib/icons/template.svg'
...
const TemplateItemComponent = ({ currentPath, isOver, canDrop, connectDropTarget, teamId }) => {
  ...
  return connectDropTarget(<div>
    <Item active={currentPath === url} path={url} Icon={TemplateIcon} name={teamId ? 'Team Templates' : 'My Templates'}
...
export const TemplateItem = DropTarget(['SANDBOX'], entryTarget, collectTarget)(withRouter(TemplateItemComponent))
