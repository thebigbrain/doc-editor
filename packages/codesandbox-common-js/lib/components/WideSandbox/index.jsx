...
import { Container, SandboxTitle, SandboxDescription, SandboxImage, SandboxInfo, TemplateIcon, Author, } from './elements';
...
export default class WideSandbox extends React.PureComponent {
    ...
    render() {
        ...
        <SandboxImage alt={this.getTitle()} src={sandbox.screenshot_url || getScreenshot(sandbox.id)} color={template.color()} style={{ height: this.state.imageLoaded ? 'auto' : defaultHeight }} ref={img => {
            if (img && img.complete) {
