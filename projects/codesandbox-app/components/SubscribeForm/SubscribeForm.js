...
import { useScript } from '@muggle/hooks'
  ...
  return (<>
    <Container>
      <StripeProvider stripe={stripe}>
        <Elements>
          <CheckoutForm buttonName={buttonName} loadingText={loadingText} subscribe={subscribe} name={name}
                        isLoading={isLoading} error={error} hasCoupon={hasCoupon}/>
        </Elements>
      </StripeProvider>
    </Container>
  </>)
