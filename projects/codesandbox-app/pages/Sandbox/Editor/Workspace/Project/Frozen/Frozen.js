...
export const Frozen = () => {
    const { actions: { editor: { frozenUpdated, sessionFreezeOverride }, }, state: { editor: { currentSandbox: { isFrozen, customTemplate }, sessionFrozen, }, }, } = useOvermind();
    useEffect(() => {
    ...
    return (<>
      <Item>
        ...
        <PropertyValue>
          <FreezeContainer>
            <Switch small right={customTemplate ? sessionFrozen : isFrozen} onClick={updateFrozenState} offMode secondary/>
          </FreezeContainer>
        </PropertyValue>
      </Item>
