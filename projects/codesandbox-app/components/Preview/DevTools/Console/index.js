...
import {ClearIcon} from '@muggle/icons';
  ...
  render() {
    ...
    return (<Container>
      <Messages ref={el => {
        ...
        <ConsoleFeed logs={messages} variant={this.props.theme.light ? 'light' : 'dark'}
                     styles={inspectorTheme(this.props.theme)} filter={filter}
...
const ConsoleFilterInput = ({ style }) => (<FilterInput placeholder="Filter" style={style}
