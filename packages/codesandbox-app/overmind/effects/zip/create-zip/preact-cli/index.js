...
import { createDirectoryWithFiles, createFile, createPackageJSON, getIndexHtmlBody, getResourceTag } from '..';
...
export default function createZip(zip, sandbox, modules, directories) {
    return zip
        ...
        if (modules.filter(m => m.directoryShortid == null && m.title === 'index.html').length ||
