...
=> {
  ...
  this
  sandbox = props.sandbox.this
  currentModule = props.currentModule.oldModule = this.currentModule
    ? :
    this
  this
.
...
.
  ...
  this
.
  typingsFetcherWorker = null
  this
.
  sizeProbeInterval = null
  this
.
  resizeEditor = debounce(this.resizeEditor, 150)
  this
.
  commitLibChanges = debounce(this.commitLibChanges, 300)
  this
.
  onSelectionChangedDebounced = debounce(
    this.onSelectionChangedDebounced,
    500,
  )
  this
.
  transpilationListener = this.setupTranspilationListener()
...
Array < ModuleCorrection >

.

swapDocuments(oldModule, newModule)
...
changeCode = (code: string, moduleId
  ? : string
) =>
{
  if (
