...
import { IViews, Status } from '../index';
import { Actions, Container, Tabs } from './elements';
import { DraggableTab, PaneTab, TabProps } from './Tab/index';
import { TabDropZone, TabDropZoneProps } from './TabDropZone/index';
...
export const DevToolTabs = ({
  ...
  const TypedTabDropZone = (TabDropZone as unknown) as React.SFC<TabDropZoneProps>;
