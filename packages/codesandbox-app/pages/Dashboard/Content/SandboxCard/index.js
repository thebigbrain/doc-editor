...
import { Container, ImageMessage, KebabIcon, PrivacyIconContainer, SandboxDetails, SandboxImage, SandboxImageContainer, SandboxInfo, SandboxTitle, StyledContextMenu, } from './elements';
...
class SandboxItemComponent extends React.PureComponent {
    ...
    render() {
        ...
        return (<StyledContextMenu style={style} isDraggingItem={isDraggingItem} id={id} childFunction className="sandbox-item" items={this.getContextItems()}>
