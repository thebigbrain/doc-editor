...
import { PaddedPreference, ConfigItem, ConfigDescription, PaddedConfig, } from '../elements';
export class ConfigWizard extends React.Component {
    ...
    render() {
        ...
        <PaddedConfig>
          <ConfigItem>
            <PaddedPreference title="Infinite Loop Protection" type="boolean" {...this.bindValue(parsedFile, 'infiniteLoopProtection')}/>
          </ConfigItem>
          <ConfigDescription>
        ...
        <PaddedConfig>
          <ConfigItem>
            <PaddedPreference title="Hard Reload on Change" type="boolean" {...this.bindValue(parsedFile, 'hardReloadOnChange')}/>
          </ConfigItem>
          <ConfigDescription>
        ...
        <PaddedConfig>
          <ConfigItem>
            <PaddedPreference title="Template" type="dropdown" options={templateOptions} mapName={name => templateNameMap[name]} {...this.bindValue(parsedFile, 'template', currentTemplate.name)}/>
          </ConfigItem>
          <ConfigDescription>
