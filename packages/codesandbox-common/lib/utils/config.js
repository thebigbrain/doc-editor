...
export const ALGOLIA_DEFAULT_INDEX = process.env.NODE_ENV === 'production' || process.env.LOCAL_SERVER
  ? 'prod_sandboxes'
  : 'dev_sandboxes'
export const STRIPE_API_KEY = process.env.NODE_ENV === 'production'
