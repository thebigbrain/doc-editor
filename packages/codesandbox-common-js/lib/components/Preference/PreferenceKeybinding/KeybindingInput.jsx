...
export default class KeybindingInput extends React.Component {
    ...
    render() {
        ...
        return (<Input style={{ width: '6rem', ...this.props.style }} value={keys.map(formatKey).join(' + ')} placeholder={placeholder} onFocus={this.handleFocus} onBlur={this.handleBlur} readOnly/>);
    }
}
