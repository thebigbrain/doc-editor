import { EditorCorrection, EditorError, ModuleCorrection, ModuleError } from '@codesandbox/common/lib/types';
...
export function clearCorrectionsFromAction<T extends ModuleCorrection | ModuleError | EditorError | EditorCorrection>(
