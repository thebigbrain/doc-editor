...
export const Description = inject('store', 'signals')(hooksObserver(({ editable, signals: { workspace: { sandboxInfoUpdated, valueChanged }, }, store: { workspace: { project: { description }, }, }, }) => {
