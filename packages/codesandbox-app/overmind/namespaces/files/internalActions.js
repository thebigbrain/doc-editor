...
import { TabType } from '@codesandbox/common/lib/types';

export const recoverFiles = ({ effects, actions, state }) => {
...
export const uploadFiles = async ({ effects }, { files, directoryShortid }) => {
  const parsedFiles = {};
