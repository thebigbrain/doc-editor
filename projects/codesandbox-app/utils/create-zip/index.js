...
import { Sandbox, Module, Directory } from '@csb/common/lib/types';
import {
  react,
  reactTs,
  vue,
  preact,
  svelte,
} from '@csb/common/lib/templates/index';
import { resolveModule } from '@csb/common/lib/sandbox/modules';

export const BLOB_ID = 'blob-url://';

const CSSTag = (resource) =>
  `<link rel="stylesheet" type="text/css" href="${resource}" media="all">`;
const JSTag = (resource) =>
