...
var _isContributor = require("./is-contributor");

var ContributorsBadge =
/*#__PURE__*/
function (_React$Component) {
  (0, _inherits2["default"])(ContributorsBadge, _React$Component);

  function ContributorsBadge() {
    var _this;

    (0, _classCallCheck2["default"])(this, ContributorsBadge);
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ContributorsBadge).apply(this, arguments));
    _this.state = {
      isContributor: false
    };
    return _this;
  ...
  (0, _createClass2["default"])(ContributorsBadge, [{
    key: "updateContributorStatus",
    value: function updateContributorStatus() {
      var _this2 = this;

      var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props;
      (0, _isContributor.isContributor)(props.username).then(function (contributor) {
        _this2.setState({
