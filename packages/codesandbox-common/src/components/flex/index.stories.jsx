...
const withCenteredBordered = (fn) => (<CenteredBordered horizontal={boolean('horizontal', false, 'Centered Props')}
...
const withColumnBordered = (fn) => (<ColumnBordered flex={boolean('flex', false, 'Column Props')}
                                                    alignItems={select('alignItems', alignItemsOptions, null, 'Column Props')}
                                                    justifyContent={select('justifyContent', justifyContentOptions, 'space-between', 'Column Props')}>
  {fn()}
</ColumnBordered>)
const RowBordered = makeBorderedContainer('Row', Row, 'orange')
const withRowBordered = (fn) => (<RowBordered alignItems={select('alignItems', alignItemsOptions, null, 'Row Props')}
                                              justifyContent={select('justifyContent', justifyContentOptions, 'space-between', 'Row Props')}>
  {fn()}
</RowBordered>)
const MaxWidthBordered = makeBorderedContainer('MaxWidth', MaxWidth, 'blue')
const withMaxWidthBordered = (fn) => (<MaxWidthBordered responsive={boolean('responsive', undefined, 'MaxWidth props')}
