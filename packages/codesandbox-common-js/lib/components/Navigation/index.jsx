...
export default class Navigation extends React.PureComponent {
    ...
    render() {
        ...
        return (<MaxWidth width={1440}>
        <Container>
          <Left>
            <a href="/">
              <StyledLogo width={40} height={40} style={{ marginRight: '1rem' }}/>
            </a>
            ...
            <Item href="https://github.com/codesandbox/codesandbox-client" target="_blank" rel="noopener noreferrer" hideOn={970}>
              GitHub
            </Item>
          ...
          <Right>
            {!user && (<Item hideOn={875} href="/signin">
                Sign In
              </Item>)}

            <Item onClick={() => {
            track('Navigation - Create Sandbox Clicked');
        }} hidePhone href="/s" rel="noopener noreferrer" button={!user}>
              Create Sandbox
            </Item>

            {user && (<Item hidePhone href="/dashboard" rel="noopener noreferrer">
                {user.username}
